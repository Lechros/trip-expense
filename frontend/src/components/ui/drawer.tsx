  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "before:bg-background before:border-border flex h-auto flex-col bg-transparent text-sm before:absolute before:inset-2 before:-z-10 before:rounded-4xl before:border",
          "data-[vaul-drawer-direction=bottom]:before:left-0 data-[vaul-drawer-direction=bottom]:before:right-0 data-[vaul-drawer-direction=bottom]:before:bottom-0",
